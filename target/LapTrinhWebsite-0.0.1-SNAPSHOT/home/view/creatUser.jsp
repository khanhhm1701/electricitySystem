	...
	<div class="pt-5">
		<div class="row">
			<div class="col-lg-6 offset-lg-3">
				<h3 class="text-center secondary-title pb-3">THÊM KHÁCH HÀNG</h3>
				<form method="POST" action="creat-user">

					<div class="form-group">
						<select class="form-control form-select form-select-sm mb-3"
							id="city" name="city" aria-label=".form-select-sm">
						...
						</select> <select class="form-control form-select form-select-sm" id="ward"
							name="ward" aria-label=".form-select-sm">
